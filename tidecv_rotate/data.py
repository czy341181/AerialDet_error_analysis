...
class Data():
	...
	def _add(self, image_id:int, class_id:int, box:object=None, score:float=1, ignore:bool=False):
	...
	def add_ground_truth(self, image_id:int, class_id:int, box:object=None):
		""" Add a ground truth. If box or mask is None, this GT will be ignored for that mode. """
		self._add(image_id, class_id, box)

	def add_detection(self, image_id:int, class_id:int, score:int, box:object=None):
		""" Add a predicted detection. If box or mask is None, this prediction will be ignored for that mode. """
		self._add(image_id, class_id, box, score=score)
